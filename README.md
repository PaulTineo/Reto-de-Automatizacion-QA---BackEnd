...
3. Para la ejecucion del proyecto se debera hacer por consola: mvn clean test "-Dkarate.env=dev" "-Demail-User=fulano@qa.com" "-Dpassword-User=teste" "-Dkarate.options=--tags @regresion"
